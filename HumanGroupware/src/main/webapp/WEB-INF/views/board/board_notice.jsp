...
<body>
    ...
    <h3>공지사항</h3>
    <br>
    <table id="noticeTable" class="table table-sm">
        <thead>
            <tr>
...
.on("click", "#btnNewPost", ()=>{
    ...
    document.location="/board/write/notice";
})
.on("click", "#btnSearch", ()=>{
   getBoardList(1);
})
...
function getBoardList(curPage){
    ...
    $.ajax({
        url: "/boardlist/notice/"+curPage+"/"+searchCategory+"/"+keyword,
        type: "post",
        dataType: "JSON",
        success: (data) => {
            ...
            $("#noticeTable tbody tr").addClass("bg-light");
